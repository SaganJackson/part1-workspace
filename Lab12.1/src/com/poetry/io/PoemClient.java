...
public class PoemClient {
    ...
    private static void writePoem() {
        try
            (PrintWriter writer = new PrintWriter(new FileWriter("haiku.txt"))) {
            writer.println("I feel the Earth's warmth");
            writer.println("Baking on my skin. I watch");
            writer.println("The flowers reach high");
        } catch (IOException e) {
            e.printStackTrace();
        }
